    ...
    useEffect(() => {
        axiosBase
            ...
            .then((res) => {
                if (res.data.api_revoked) {
                    ...
                    throw new Error(
                        JSON.stringify({
                            api_revoked: true,
                            message: "Error: API Key is revoked",
                        })
                    );
                }
            ...
            .catch((err) => {
                ...
                } else setApiKey("Error: Something went wrong");
            });
    }, []);
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            <Box>
                ...
                <Typography variant="caption" sx={{ fontFamily: "Poppins" }}>
                    These key will allow you to authenticate API requests.
                </Typography>
            </Box>
            <Card>
                <CardContent
                ...
                >
                    ...
                    >
                        <Box>
                            ...
                            >
                                This is the key you will need to interact with
                                the API
                            </Typography>
                        </Box>
                    ...
                    >
                        <Box>
                            ...
                            >
                                It will create a new API key and delete the
                                previous API key.
                            </Typography>
                        </Box>
                        <Box>
                    ...
                    >
                        <Box>
                            ...
                            <Typography
                                ...
                                sx={{ fontFamily: "Poppins", fontWeight: 400 }}
                            >
                                It will revoke all services associated with this
                                API key.
                            </Typography>
                        </Box>
                        <Box>
                    ...
                    >
                        <Box>
                            ...
                            <Typography
                                ...
                                sx={{ fontFamily: "Poppins", fontWeight: 400 }}
                            >
                                Grant access to previous Revoked API Key.
                            </Typography>
                        </Box>
                        <Box>
                            <Button
            ...
            <React.Suspense fallback={<MainContentLoading />}>
                <RollApiModal
                    rollApiOpen={rollApiOpen}
                    setRollApiOpen={setRollApiOpen}
                    setApiKey={setApiKey}
                />
            </React.Suspense>
            <React.Suspense fallback={<MainContentLoading />}>
                <RevokeApiModal
                    revokeApiOpen={revokeApiOpen}
                    setApiRevoked={setApiRevoked}
                    setRevokeApiOpen={setRevokeApiOpen}
                    setApiKey={setApiKey}
                />
            </React.Suspense>
        </Box>
