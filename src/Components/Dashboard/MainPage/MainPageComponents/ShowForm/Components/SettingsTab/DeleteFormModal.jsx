...
const DeleteFormModal = ({ deleteFormOpen, setDeleteFormOpen, formData }) => {
    ...
    const handleDeleteForm = () => {
        ...
        setIsError(false);
        axios
            .post("/delete-form", { form_id: formData?.form_id })
            .then((res) => {
                navigate("/dashboard");
            })
            .catch((err) => {
                ...
                <Card sx={deleteAccountSx}>
                    <CardContent sx={{ p: 0 }}>
                        ...
                        >
                            ...
                            <Typography sx={{ fontFamily: "Poppins" }}>
                                {formData?.form_data?.length} form submissions
                            </Typography>
                            <Box
                                sx={{
                            ...
                            >
                                <Box sx={{ position: "relative" }}>
                                    ...
                                    <Typography
                                        variant="caption"
                                        align="center"
                                        sx={{ fontFamily: "Poppins", pl: 3 }}
                                    >
                                        All form submissions associated with
                                        this form will be delete permanently.
                                        This process cannot be undo, so please
                                        be certain.
                                    </Typography>
                                </Box>
                                <Box sx={{ position: "relative" }}>
                                    ...
                                    <Typography
                                        ...
                                        sx={{ fontFamily: "Poppins", pl: 3 }}
                                    >
                                        Download the form submissions before
                                        deleting.
                                    </Typography>
                                </Box>
                            </Box>
