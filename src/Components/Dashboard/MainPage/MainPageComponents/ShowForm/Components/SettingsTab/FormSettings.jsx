...
const FormSettings = ({ formData, setFormData }) => {
    ...
    const editSendMail = (value) => {
        ...
        axiosBase
            .post("/change-send-mail", { formId: formData?.form_id, value })
            .then(() => {
    ...
    const editForm = () => {
        ...
        axiosBase
            .post(
                "/edit-form",
                { formName, formId: formData?.form_id },
            ...
            .then((response) => {
                if (response.status === 200) {
                    ...
                    setEditFormLabel({
                        state: "success",
                        label: "Form updated successfully",
                    });
                }
            })
            .catch(() => {
    ...
    const changeService = (value, state) => {
        state(true);
        axiosBase
            .post("/change-service", { formId: formData?.form_id, value })
            .then(() => {
                state(false);
                setFormData((prev) => {
                ...
                <Card>
                    <CardContent>
                        ...
                        >
                            ...
                            >
                                You will receive a notification via email every
                                time a new form submission occurs.
                            </Typography>
                            {sendMailLoad ? (
                    ...
                    <CardContent>
                        ...
                        >
                            ...
                            >
                                Temporarily stop accepting submissions from this
                                form.
                            </Typography>
                            <Box
                                sx={{
                            ...
                            >
                                <Typography
                                    sx={{
                                        fontFamily: "Poppins",
                                        color: formData?.service_cancelled
                                            ? "#d32f2f"
                                            : "rgb(91, 222, 195)",
                                    }}
                                >
                                    {formData?.service_cancelled
                                        ? "Service stopped"
                                        : "Service running"}
                                </Typography>
                                <Button
                    ...
                    <CardContent>
                        ...
                        >
                            ...
                            >
                                Once you delete this form, there is no going
