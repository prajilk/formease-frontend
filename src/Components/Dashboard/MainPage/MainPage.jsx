...
const ShowForm = React.lazy(() =>
    import("./MainPageComponents/ShowForm/ShowForm")
);
const CreateForm = React.lazy(() =>
    import("./MainPageComponents/CreateForm/CreateForm")
);
const DashboardHome = React.lazy(() =>
    import("./MainPageComponents/DashboardHome/DashboardHome")
);
const Api = React.lazy(() => import("./MainPageComponents/API/Api"));
const Settings = React.lazy(() =>
    import("./MainPageComponents/Settings/Settings")
);
